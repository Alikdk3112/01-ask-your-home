...
export const STEPS: Record<StepId, Step> = {
  motivation: {
    ...
    options: [
      ...
      { label: 'Honestly: all of it', value: 'alles', icon: Wallet },
    ],
  },
  ownership: {
    id: 'ownership',
  ...
  constructionPeriod: {
    ...
    input: 'preset',
    options: [
      { label: 'Before 1978', value: 'vor_1978' },
      { label: '1978 – 1995', value: '1978_1995' },
      { label: '1995 – 2010', value: '1995_2010' },
      { label: 'After 2010', value: 'nach_2010' },
      { label: 'I don’t know', value: 'unbekannt' },
    ],
  },
  livingArea: {
    id: 'livingArea',
    ...
    input: 'preset',
    options: [
      { label: 'Under 50 m²', value: 40 },
      { label: '50 – 80 m²', value: 65 },
      { label: '80 – 120 m²', value: 100 },
      { label: '120 – 160 m²', value: 140 },
      { label: 'Over 160 m²', value: 200 },
    ],
  },
  plz: {
    id: 'plz',
  ...
  heating: {
    ...
    options: [
      ...
      { label: 'I don’t know', value: 'unbekannt', icon: Plug },
    ],
  },
  landlordRelation: {
    id: 'landlordRelation',
    ...
    input: 'preset',
    options: [
      { label: 'Easy to reach', value: 'gut' },
      { label: 'So-so', value: 'geht_so' },
      { label: 'Rather difficult', value: 'schwierig' },
      { label: 'Property management', value: 'hausverwaltung' },
    ],
  },
  insulation: {
    id: 'insulation',
    ...
    input: 'preset',
    options: [
      { label: 'Yes, fully', value: 'ja' },
      { label: 'Partly', value: 'teilweise' },
      { label: 'No', value: 'nein' },
      { label: 'I don’t know', value: 'unbekannt' },
    ],
  },
  budget: {
    ...
    options: [
      ...
      { label: 'Just exploring for now', value: 'informieren', icon: Sparkles },
    ],
  },
  monthlyCost: {
    id: 'monthlyCost',
  ...
  existingMeasures: {
    ...
    input: 'preset',
    options: [
      { label: 'Yes, quite a bit', value: 'viel', icon: Wrench },
      { label: 'Partly', value: 'teilweise', icon: Wrench },
      { label: 'Nothing yet', value: 'nichts', icon: Lightbulb },
      { label: 'I don’t know', value: 'unbekannt', icon: Plug },
    ],
    interstitial: {
